        ...
        <div className="flex">
          <div className="relative w-[50%] max-w-[200px] md:max-w-[232px] shrink-0 aspect-square rounde-r-none overflow-hidden">
            <Image
              ...
              fill
              quality={75}
              className="object-fill rounded-l-[6px]"
            />
          </div>
          <div className=" py-[20px] pl-[26px] pr-[20px] w-full bg-white ">
            <div className="flex items-center">
              <span className="font-semibold text-[13px] mr-[6px] text-blue-6">
                {isFinished ? "종료됨" : "진행중"}
              </span>
            ...
            <span className="block mt-[15px] text-[14px] text-gray-6">
              냉장고 보관 용기
            </span>
            <h4 className="mt-[10px] font-bold text-[20px] text-gray-6 line-clamp-2 h-[48px]">
              {title}
            </h4>
            <p className="mt-[8px] font-bold text-[14px] text-gray-5">
              <span className="text-red-5">24,000원</span>을{" "}
            ...
            <div className="mt-[12px] flex gap-[10px]">
              <Label
                ...
                name={`${peopleNum - application.length}명 남음`}
              />
              <Label
                color="bg-yellow-1"
