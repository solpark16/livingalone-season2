        ...
        <div className={`${is_finished ? "text-gray-3" : ""}`}>
          ...
          <div className="flex justify-between mt-[23px]">
            <div className="flex gap-2 items-center">
              <Image src={profile_image_url} alt="프로필 사진" width={40} height={40} className="rounded-full h-10" />
              <div>
                <p>{nickname}</p>
            ...
            <div className="flex">
              <p className={`text-[14px] md:text-[20px] ${is_finished ? "text-gray-3 md:text-gray-2" : "text-red-3"}`}>
                달성률 <span className="font-bold text-[28px] md:text-[36px]">{achievementRate}%</span>
              </p>
            </div>
          </div>
          <div className="mt-5">
            <p className="text-[14px] md:text-[16px] text-gray-3">마감일 {end_date} 까지</p>
            ...
            <p className="mb-[20px] text-[14px] md:text-[16px] font-bold text-gray-3">{item}</p>
