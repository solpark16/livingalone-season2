        ...
        <>
          <ul>
            {applications.map((application, index) => (
              ...
              >
                <div className="flex justify-between flex-1 flex-col md:flex-row gap-1">
                  <div className="flex justify-start gap-3 font-bold text-[14px] md:text-[16px]">
                    <div>{index + 1}.</div>
                    <div className="shrink-0">{application.user_name}</div>
                  </div>
                  <div className="shrink-0 text-[14px] md:text-[16px] text-gray-5">
                ...
                <div
                  className={`flex flex-1 items-end justify-end ${
                    application.is_paid ? "text-main-7" : "text-red-5"
                  }`}
                >
