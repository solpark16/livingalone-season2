...
function MustSection() {
  ...
  return (
    <div className="container mx-auto xl:max-w-[1200px] pt-[42px] pb-[132px] lg:pt-[58px] lg:pb-[153px]">
      <MainSectionTitle
        title="자랑해 자취템"
      ...
      <div className="md:hidden w-full flex justify-center mt-[40px]">
        <div className="border border-main-8 rounded-full w-[108px]">
          <Link className="text-[16px] font-bold text-main-8 flex items-center py-[8px] px-[18px]" href="/mustpost">
            전체보기
